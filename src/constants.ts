...
export const MOCK_EMPLOYEES: Employee[] = [
  {
    ...
    walletAddress: '0x71C234E5F6A7B8C9D0E1F2A3B4C5D6E7F3A9f',
    salary: 12500,
    tokenType: 'USDC',
    status: 'active',
  ...
  },
  {
    ...
    department: 'Design',
    walletAddress: '0x2B4C5D6E7F8A9B0C1D2E3F4A5B6C7D8E91E2',
    salary: 10000,
    tokenType: 'USDC',
    status: 'onboarding',
  ...
  },
  {
    ...
    department: 'Engineering',
    walletAddress: '0x9fA1B2C3D4E5F6A7B8C9D0E1F2A3B4C5D44Bc',
    salary: 8500,
    tokenType: 'USDT',
    status: 'active',
  ...
  },
  {
    ...
    walletAddress: '0xE11F2A3B4C5D6E7F8A9B0C1D2E3F4A5B88Ff',
    salary: 15000,
    tokenType: 'USDC',
    status: 'inactive',
